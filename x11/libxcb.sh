...
PACKAGENAME=libxcb
VERSION=1.11
SOURCEURL=http://xcb.freedesktop.org/dist/${PACKAGENAME}-${VERSION}.tar.bz2
...
The libxcb package provides an interface to the X Window System protocol. Xlib can also use
XCB as a transport layer, allowing software to make requests and receive responses with both. 
Version:${VERSION}
Homepage:${HOMEURL}

Depends on these packages:
br2:libXau br2:libXdmcp br2:xcb-proto br2:uclibc-solibs
