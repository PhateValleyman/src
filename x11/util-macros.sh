...
PACKAGENAME=util-macros
VERSION=1.19.0
SOURCEURL=http://xorg.freedesktop.org/releases/individual/util/${PACKAGENAME}-${VERSION}.tar.bz2
...
br2:automake br2:autoconf br2:pkg-config s:perl
