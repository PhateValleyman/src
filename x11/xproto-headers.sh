...
The xproto-headers package provides the Xorg protocol headers files required to allow other
applications to build against the X Window system.
Version:${VERSION}
Homepage:${HOMEURL}
