...
GNU_HOST=$GNU_BUILD
BUILDDIR=/mnt/HD_a2/build/xz
PACKAGENAME=xz
VERSION="5.2.5"
#SOURCEURL=http://tukaani.org/${PACKAGENAME}/${PACKAGENAME}-${VERSION}.tar.xz
SOURCEURL=http://192.168.1.20:88/MyWeb/COMPILER/finish/xz-5.2.5.tar.xz
HOMEURL=http://tukaani.org/xz/
...
License(s): GNU LGPLv2.1, GNU GPLv2, or GNU GPLv3
Version: ${VERSION}
Homepage: ${HOMEURL}
