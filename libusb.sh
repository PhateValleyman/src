...
PACKAGENAME=libusb
VERSION="1.0.21"
SOURCEURL=https://github.com/${PACKAGENAME}/${PACKAGENAME}/releases/download/v${VERSION}/${PACKAGENAME}-${VERSION}.tar.bz2
...
libusb is a C library that provides generic access to USB devices. It is intended to be used by
