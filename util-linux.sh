...
GNU_HOST=$GNU_BUILD
BUILDDIR=/mnt/HD_a2/build/util-linux
PACKAGENAME=util-linux
VERSION="2.38"
SOURCEURL=https://www.kernel.org/pub/linux/utils/util-linux/v${VERSION:0:4}/${PACKAGENAME}-${VERSION}.tar.xz
#SOURCEURL=http://192.168.1.20:88/MyWeb/COMPILER/finish/util-linux-2.38.tar.xz
HOMEURL=https://www.kernel.org/pub/linux/utils/util-linux/
...
cd ${BUILDDIR}
wget --no-check-certificate -nv ${SOURCEURL}
...
The Util-linux package contains miscellaneous utility programs. Among them are utilities for
...
ncurses readline uClibc-solibs zlib
