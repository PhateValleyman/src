...
make utils
echo "$(date)"
# Using with pregenerated locale .config .locale_data.os.dep needs to be removed before installing
# Use make pregen and make inside extra/locale dir for pregenerated locale
rm extra/locale/.locale_data.os.dep
