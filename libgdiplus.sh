...
PACKAGENAME=libgdiplus
VERSION=3.12
SOURCEURL=http://download.mono-project.com/sources/${PACKAGENAME}/${PACKAGENAME}-${VERSION}.tar.gz
HOMEURL=http://www.mono-project.com/docs/gui/libgdiplus
...
# Apply patch
wget 'https://projects.archlinux.org/svntogit/packages.git/plain/trunk/libgdiplus0-giflib5.patch?h=packages/libgdiplus' -O ${PACKAGENAME}.patch
...
Libgdiplus is the Mono library that provide a GDI+ comptible API for non-Windows operating systems.  
License: MPL,LGPL
Version:${VERSION}
Homepage:${HOMEURL}
