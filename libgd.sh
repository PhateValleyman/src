...
PACKAGENAME=libgd
VERSION="2.2.3"
SOURCEURL=https://github.com/${PACKAGENAME}/${PACKAGENAME}/releases/download/${PACKAGENAME#lib}-${VERSION}/${PACKAGENAME}-${VERSION}.tar.xz
HOMEURL=https://libgd.github.io/
...
GD is written in C, and "wrappers" are available for Perl, PHP and other languages. GD can read
and write many different image formats. GD is commonly used to generate charts, graphics, thumbnails.
License: Custom (https://github.com/libgd/libgd/blob/master/COPYING)
Version: ${VERSION}
Homepage: ${HOMEURL}
...
ln -s libgd.so.3.0.3 ${BUILDDIR}/ffp/lib/libgd.so.2
