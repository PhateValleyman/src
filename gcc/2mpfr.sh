...
GNU_HOST=$GNU_BUILD
BUILDDIR=/mnt/HD_a2/build/mpfr
PACKAGENAME=mpfr
VERSION=4.1.0
SOURCEURL=http://www.mpfr.org/mpfr-current/${PACKAGENAME}-${VERSION}.tar.xz
HOMEURL=http://www.mpfr.org
STARTTIME=$(date +"%s")
...
wget -nv http://www.mpfr.org/mpfr-current/allpatches
patch -p1 < allpatches
...
# Autoreconf  is required after applied patches (changed configure.ac file)
autoreconf -fi
