...
GNU_HOST=$GNU_BUILD
BUILDDIR=/mnt/HD_a2/build/help2man
PACKAGENAME=help2man
VERSION="1.49.1"
#SOURCEURL=http://ftp.gnu.org/gnu/${PACKAGENAME}/${PACKAGENAME}-${VERSION}.tar.xz
SOURCEURL=http://192.168.1.20:88/MyWeb/COMPILER/finish/help2man-1.49.1.tar.xz
HOMEURL=http://www.gnu.org/software/help2man/
STARTTIME=$(date +"%s")
...
#tar -vxf /i-data/md1/COMPILER/finish/help2man-1.49.1.tar.xz
...
This program is intended to provide an easy way for software authors to include a manual page in
their distribution without having to maintain that document.
License:GNU GPLv3+
Version:${VERSION}
Homepage:${HOMEURL}

Depends on these packages:
s:perl br2:perl-modules br2:gettext br2:texinfo
...
#perl perl-modules gettext texinfo
#EOF
