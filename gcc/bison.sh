...
#
#ATENTION, BEFORE BUILDING !!!
#UNINSTALL FROM SYSTEM CURRENT BISON, OTHERWISE MAKE CHECK TESTS WILL FAIL
#
...
GNU_HOST=$GNU_BUILD
BUILDDIR=/mnt/HD_a2/build/bison
PACKAGENAME=bison
VERSION="3.8.2"
SOURCEURL=http://ftp.gnu.org/gnu/${PACKAGENAME}/${PACKAGENAME}-${VERSION}.tar.gz
HOMEURL=http://www.gnu.org/software/bison/
STARTTIME=$(date +"%s")
...
Once you are proficient with Bison, you can use it to develop a wide range of language parsers,
from those used in simple desk calculators to complex programming languages. Bison is upward
compatible with Yacc: all properly-written Yacc grammars ought to work with Bison with no change.
License:GNU GPLv3+
Version:${VERSION}
Homepage:${HOMEURL}

Depends on these packages:
br2:libiconv br2:gettext br2:m4 br2:uClibc br2:uClibc-solibs
