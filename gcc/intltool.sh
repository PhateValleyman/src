...
GNU_HOST=$GNU_BUILD
BUILDDIR=/mnt/HD_a2/build/intltool
PACKAGENAME=intltool
VERSION="0.51.0"
SOURCEURL=https://launchpad.net/${PACKAGENAME}/trunk/${VERSION}/+download/${PACKAGENAME}-${VERSION}.tar.gz
HOMEURL=http://freedesktop.org/wiki/Software/intltool/
STARTTIME=$(date +"%s")
...
s:perl br2:perl-modules or separate perl-xmlparser package
