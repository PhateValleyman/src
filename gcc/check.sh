...
GNU_HOST=$GNU_BUILD
BUILDDIR=/mnt/HD_a2/build/check
PACKAGENAME=check
VERSION="0.15.2"
#SOURCEURL=http://downloads.sourceforge.net/sourceforge/${PACKAGENAME}/${PACKAGENAME}-${VERSION}.tar.gz
SOURCEURL=https://github.com/libcheck/check/releases/download/0.15.2/check-0.15.2.tar.gz
HOMEURL=http://check.sourceforge.net/
STARTTIME=$(date +"%s")
...
putting little in the way of the developer. Tests are run in a separate address space, so both
assertion failures and code errors that cause segmentation faults or other signals can be caught.
Test results are reportable in the following: Subunit, TAP, XML, and a generic logging format.
License:LGPL
Version:${VERSION}
Homepage:${HOMEURL}

Depends on these packages:
br2:uClibc br2:uClibc-solibs s:gawk
