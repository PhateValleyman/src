...
HOMEURL=http://www.multiprecision.org/
STARTTIME=$(date +"%s")
...
The MPC package contains a library for the arithmetic of complex numbers with arbitrarily high 
...
br2:uClibc br2:uClibc-solibs br2:gmp br2:mpfr
