...
GNU_HOST=$GNU_BUILD
BUILDDIR=/mnt/HD_a2/build/m4
PACKAGENAME=m4
VERSION="1.4.19"
#SOURCEURL=http://ftp.gnu.org/gnu/${PACKAGENAME}/${PACKAGENAME}-${VERSION}.tar.gz
SOURCEURL=http://192.168.1.20:88/MyWeb/COMPILER/finish/m4-1.4.19.tar.gz
HOMEURL=http://www.gnu.org/software/m4/
STARTTIME=$(date +"%s")
...
./configure \
	...
	--host=$GNU_HOST \
	--prefix=/ffp \
	--with-syscmd-shell=/ffp/bin/bash \
