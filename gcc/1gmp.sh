...
GNU_HOST=$GNU_BUILD
BUILDDIR=/mnt/HD_a2/build/gmp
PACKAGENAME=gmp
VERSION=6.2.1
SOURCEURL=https://gmplib.org/download/${PACKAGENAME}/${PACKAGENAME}-${VERSION}.tar.xz
HOMEURL=https://gmplib.org/
STARTTIME=$(date +"%s")
...
The GMP package contains math libraries.
These have useful functions for arbitrary precision arithmetic.
License(s):LGPLv3, GPLv2   
Version:${VERSION}
Homepage:${HOMEURL}

Depends on these packages:
br2:gcc br2:gcc-solibs br2:uClibc br2:uClibc-solibs
