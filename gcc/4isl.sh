...
PACKAGENAME=isl
VERSION=0.13
SOURCEURL=http://isl.gforge.inria.fr/${PACKAGENAME}-${VERSION}.tar.gz
HOMEURL=http://isl.gforge.inria.fr/
STARTTIME=$(date +"%s")
...
constraints. Supported operations on sets include intersection, union, set difference, emptiness 
check, convex hull, (integer) affine hull, integer projection, and computing the lexicographic 
minimum using parametric integer programming. It also includes an ILP solver based on generalized 
basis reduction and operations geared towards polyhedral compilation such as dependence analysis,
scheduling, and AST generation.
License(s):MIT
Version:${VERSION}
Homepage:${HOMEURL}

Depends on these packages:
br2:uClibc br2:uClibc-solibs br2:gmp
