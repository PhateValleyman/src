...
PACKAGENAME=libwebsockets
VERSION="2.1.0"
SOURCEURL=https://github.com/warmcat/libwebsockets/archive/v${VERSION}.tar.gz
HOMEURL=https://libwebsockets.org
...
Libwebsockets is a lightweight pure C library built to use minimal CPU and memory resources
and provide fast throughput in both directions as client or server. 
License(s): LGPLv2.1 with exceptions
Version: ${VERSION}
Homepage: ${HOMEURL}
