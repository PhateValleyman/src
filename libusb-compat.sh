...
PACKAGENAME=libusb-compat
VERSION="0.1.5"
SOURCEURL=http://downloads.sourceforge.net/${PACKAGENAME%-*}/${PACKAGENAME}-${VERSION%.*}/${PACKAGENAME}-${VERSION}/${PACKAGENAME}-${VERSION}.tar.bz2
HOMEURL=http://libusb.info/
...
libusb-compat package provides compatibility layer allowing applications written for libusb-0.1 to work
with libusb-1.0.
License: LGPL
Version: ${VERSION}
Homepage: ${HOMEURL}
