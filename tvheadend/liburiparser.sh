...
PACKAGENAME=uriparser
VERSION=0.8.4
SOURCEURL=http://downloads.sourceforge.net/sourceforge/${PACKAGENAME}/${PACKAGENAME}-${VERSION}.tar.bz2
HOMEURL=http://uriparser.sourceforge.net/
...
Uriparser is a strictly RFC 3986 compliant URI parsing library. uriparser is cross-platform, fast 
