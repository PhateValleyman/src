...
PACKAGENAME=sqlite
VERSION=3.8.10.2
SOURCEURL=https://www.sqlite.org/2015/sqlite-autoconf-3081002.tar.gz # try echo "${VERSION//[-._]/0}"
HOMEURL=https://www.sqlite.org
...
cd ${BUILDDIR}
#wget-1.12 has bug checking Subject Alternative Names (SAN) properly. --no-check-certificate 
...
mv sqlite-autoconf-3081002 ${PACKAGENAME}-${VERSION}
...
transactional SQL database engine. SQLite is the most widely deployed database engine in the world.  
License: custom:Public Domain
Version:${VERSION}
Homepage:${HOMEURL}
Depends on these packages:
ncurses readline uClibc-solibs
