...
GNU_HOST="$GNU_BUILD"
BUILDDIR=/mnt/HD_a2/build/shine
PACKAGENAME=shine
SOURCEURL="https://github.com/toots/shine"
HOMEURL="https://github.com/toots/shine"
...
VERSION=$(grep -o 'version-info.*' ${PACKAGENAME}/Makefile.am | cut -d ' ' -f2 | sed 's|:|.|g')_git${REVISION}
cd ${PACKAGENAME}
...
shine is a blazing fast mp3 encoding library implemented in fixed-point arithmetic. The library can
thus be used to performe super fast mp3 encoding on architectures without a FPU, such as  armel , etc..
