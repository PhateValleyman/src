...
GNU_HOST="$GNU_BUILD"
BUILDDIR=/mnt/HD_a2/build/libwebp
PACKAGENAME=libwebp
VERSION="1.2.3"
SOURCEURL=http://downloads.webmproject.org/releases/webp/${PACKAGENAME}-${VERSION}.tar.gz
HOMEURL=https://developers.google.com/speed/webp/
...
#Create symlink for compatability with older version
ln -s libwebp.so ${BUILDDIR}/ffp/lib/libwebp.so.5
