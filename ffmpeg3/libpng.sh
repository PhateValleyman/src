...
PACKAGENAME=libpng
VERSION="1.6.29"
SOURCEURL=https://downloads.sourceforge.net/sourceforge/${PACKAGENAME}/${PACKAGENAME}-${VERSION}.tar.xz
HOMEURL=https://www.libpng.org/pub/png/libpng.html
...
wget -nv https://downloads.sourceforge.net/project/libpng-apng/libpng16/${VERSION}/${PACKAGENAME}-${VERSION}-apng.patch.gz
gunzip ${PACKAGENAME}-${VERSION}-apng.patch.gz
patch -p1 < ${PACKAGENAME}-${VERSION}-apng.patch
...
./configure \
	...
	--enable-arm-neon=no
make
# All tests passes, but takes long time
#make check
...
License(s): Open Source. http://www.libpng.org/pub/png/src/libpng-LICENSE.txt
Version: ${VERSION}
Homepage: ${HOMEURL}
...
ln -s libpng.so ${BUILDDIR}/ffp/lib/libpng14.so.14
