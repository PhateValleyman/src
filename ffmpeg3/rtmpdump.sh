...
# Might be useful to look at the https://gitweb.gentoo.org/repo/gentoo.git/tree/media-video/rtmpdump/rtmpdump-9999.ebuild
# before compiling 
...
GNU_HOST="$GNU_BUILD"
BUILDDIR=/mnt/HD_a2/build/rtmpdump
PACKAGENAME="rtmpdump"
SOURCEURL="git://git.ffmpeg.org/rtmpdump"
HOMEURL="https://rtmpdump.mplayerhq.hu/"
...
VERSION="$(grep "VERSION=v" ${PACKAGENAME}/Makefile | cut -f2 -d'v')_git${REVISION}"
cd ${PACKAGENAME}
...
colormake SYS=posix OPT="$CFLAGS" XLDFLAGS="$LDFLAGS" CRYPTO="GNUTLS" prefix=/ffp
colormake prefix=/ffp sbindir=/ffp/bin mandir=/ffp/share/man CRYPTO="GNUTLS" DESTDIR=${BUILDDIR} install
