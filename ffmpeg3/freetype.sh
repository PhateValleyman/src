...
GNU_HOST="$GNU_BUILD"
BUILDDIR=/mnt/HD_a2/build/freetype
PACKAGENAME=freetype
VERSION="2.12.1"
SOURCEURL=https://download-mirror.savannah.gnu.org/releases/${PACKAGENAME}/${PACKAGENAME}-${VERSION}.tar.gz
...
# Enable GX/AAT and OpenType table validation plus subpixel rendering
...
FreeType is a freely available software library to render fonts. It is written in C, designed to be
small, efficient, highly customizable, and portable while capable of producing high-quality output
(glyph images) of most vector and bitmap font formats.
License(s): FTL or GPLv2 (https://www.freetype.org/license.html)
Version: ${VERSION}
Homepage: ${HOMEURL}
