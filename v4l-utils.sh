...
#
# Uninstall qt4 or qt5 amd alsa packages before building
# Install after again
#
...
PACKAGENAME="v4l-utils"
VERSION="1.10.0"
SOURCEURL=https://www.linuxtv.org/downloads/${PACKAGENAME}/${PACKAGENAME}-${VERSION}.tar.bz2 
HOMEURL="https://www.linuxtv.org"
...
cd ${BUILDDIR}
wget -nv ${SOURCEURL}
tar xf ${PACKAGENAME}-${VERSION}.tar.bz2
...
v4l-utils provides a series of utilities for media devices, allowing to handle the proprietary
formats available at most webcams (libv4l), and providing tools to test V4L devices.
License: LGPL
Version:${VERSION}
Homepage:${HOMEURL}

Depends on these packages:
br2:gcc-solibs br2:libiconv s:libjpeg br2:uClibc-solibs
...
# Correct paths in udev rules
sed -i "s|/usr/bin/ir-keytable|/ffp/bin/ir-keytable|" ${BUILDDIR}/ffp/lib/udev/rules.d/70-infrared.rules
sed -i "s|/etc/rc_maps.cfg|/ffp/etc/rc_maps.cfg|" ${BUILDDIR}/ffp/lib/udev/rules.d/70-infrared.rules
