...
GNU_HOST=$GNU_BUILD
BUILDDIR=/mnt/HD_a2/build/libksba
PACKAGENAME=libksba
VERSION=1.6.2
...
Libksba is a library to make the tasks of working with X.509 certificates, CMS data and related
objects more easy. It provides a highlevel interface to the implemented protocols and presents
