...
GnuPG is a complete and free implementation of the OpenPGP standard. GnuPG allows to encrypt and sign
your data and communication, features a versatile key management system as well as access modules for
all kinds of public key directories.
License:GPL
Version:${VERSION}
Homepage:${HOMEURL}
Depends on these packages:
bzip2 gnutls libassuan libgcrypt libiconv libgpg-error libksba npth sqlite readline uClibc-solibs zlib
...
# Add gnutls to list of deps
sed -i "1 s|$| gnutls|" ${BUILDDIR}/install/DEPENDS
