...
GNU_HOST=$GNU_BUILD
BUILDDIR=/mnt/HD_a2/build/nettle
PACKAGENAME=nettle
VERSION=3.8
SOURCEURL=https://ftp.gnu.org/gnu/${PACKAGENAME}/${PACKAGENAME}-${VERSION}.tar.gz
HOMEURL=http://www.lysator.liu.se/~nisse/nettle/
...
In crypto toolkits for object-oriented languages (C++, Python, Pike, ...), in applications like LSH
