...
PKIDIR="/ffp/etc/pki"
SSLDIR="/ffp/etc/ssl"
CERTUTIL="/ffp/bin/certutil"
KEYTOOL="/ffp/opt/java/jre/bin/keytool"
...
/ffp/bin/c_rehash "${DESTDIR}${CERTDIR}" 2>&1>/dev/null
popd > /dev/null

# Clean up the mess
rm -rf "${TEMPDIR}"

# End /ffp/sbin/make-ca.sh
