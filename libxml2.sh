...
PACKAGENAME=libxml2
VERSION="2.9.2"
SOURCEURL=http://xmlsoft.org/sources/${PACKAGENAME}-${VERSION}.tar.gz
HOMEURL=http://xmlsoft.org/
STARTTIME=$(date +"%s")
...
# Get tests
wget -nv http://www.w3.org/XML/Test/xmlts20130923.tar.gz
...
./configure \
	...
	--with-history \
	--with-zlib=/ffp
# libxml2 links specific icu version, which will cause problems updating icu or libxml2 itself.
# Downside of building without icu-make check will not pass without it
#	--with-icu
...
This package contains libraries and utilities used for parsing XML files.
License:MIT
Version:${VERSION}
Homepage:${HOMEURL}

Depends on these packages:
br2:gcc-solibs br2:libiconv br2:python-2.7.* br2:ncurses br2:readline br2:uClibc-solibs
s:xz-5.* s:zlib
